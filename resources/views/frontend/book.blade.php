...
<body class="font-poppins text-black">
    <section id="content" class="max-w-[640px] w-full mx-auto bg-[#F9F2EF] min-h-screen flex flex-col gap-8 pb-[120px]">
        <nav class="mt-8 px-4 w-full flex items-center justify-between">
          <a href="{{ route('details',$packageTour->slug) }}">
        ...
        <form action="{{ route('book',$packageTour->slug) }}" method="POST" class="flex flex-col gap-8">
          ...
          <div class="flex flex-col gap-3 px-4 ">
            ...
            <div class="bg-white p-4 rounded-[26px] flex items-center gap-3">
              ...
              <div class="flex flex-col gap-1">
                <p class="font-semibold text-sm tracking-035 leading-[22px]">{{ $packageTour->name }}<br>{{ $packageTour->category->name }}</p>
          ...
          <div class="flex flex-col gap-3 px-4 ">
            ...
            <div class="bg-white p-[16px_24px] rounded-[26px] flex flex-col gap-3">
              ...
              <div class="flex justify-between items-center text-sm tracking-035 leading-[22px]">
                <p>Phone</p>
                <p class="font-semibold">{{ Auth::user()->phonenumber }}</p>
              </div>
            </div>
          </div>
          <div class="flex flex-col gap-3 px-4 ">
